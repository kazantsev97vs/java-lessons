package part_3_Java_Multithreading.lesson_17__multithreading;

/**
 * Многопоточность позволяет выполнять какой-то код параллельно с другим кодом. (Неважно сколько ядер)
 *
 ...
 *      Thread - поток
 *
 *      public void run() - метод, который следует переопределить, для выполнения заданного кода в потоке
 *
...
class MyThread extends Thread {
    ...
    /**
     * Здесь пишется код, который мы хотим чтобы выполнился в потоке
     */
    @Override
    public void run() {
